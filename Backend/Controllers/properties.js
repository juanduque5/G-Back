...
exports.postProperties = async (req, res, next) => {
  ...
  const files = req.files; // Accede a los archivos subidos a través de req.files
  const formData = req.body.ciudad; // Accede a otros campos del formulario a través de req.body
